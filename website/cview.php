...
<?php include('inc/inc_header.php'); ?>
	...
	<div class="container">
			...
			<div  class="titl">
				<row>
					<div class="col-md-12">
				<span class="title"><?php echo $idata['page_name']; ?></span>  <span class="loc"><i class="fa fa-home"></i> > <?php echo $cat[$c]; ?> ><?php echo $idata['page_name']; ?></span>
			</div>
</row>
			</div>
		<div class="clear"></div>	
...
<!---Introduction-->
 ...
 <?php echo $idata['details']; ?> <a href="#"></a>
  ...
  <hr>
  <a class="btn btn-success" style="color: #fff;" href="<?php echo $idata['file_url']; ?>" target="_blank"><i class="fa fa-download"></i> डाउनलोड</a>
