                       ...
                       <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              तथ्याङ्गक सम्बन्धि विवरण
                            </div>
 <div class="panel-body">

   <form method="post" action="#">
  <div class="col-lg-5">
<input type="text" name="niti" placeholder="तथ्याङ्गक सम्बन्धि विवरण " required="required" class="form-control">
</div>
  <div class="col-lg-4">
<select class="form-control" name="fy" required="required">
  <option value="">--आर्थिक वर्ष छान्नुहाेस--</option>
  <?php
  foreach ($fy as $data){
?>
