...
class FrontendController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('frontend.index', compact('officeDetail', 'tickerFiles', 'sliders', 'categories', 'galleries', 'subDivisions','bidSetting'));
    }
    ...
    public function bid(StoreBidRequest $request)
    {
        Bid::create($request->validated());

        return back()->with('message', "Bid Sent Successfully");
    }
}
