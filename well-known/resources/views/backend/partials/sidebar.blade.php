<aside class="sidebar-nav-wrapper">
    <div class="navbar-logo">
        <a href="{{route('admin.dashboard')}}">
            ...
            {{--            <img src="{{asset('assets/backend/images/logo/logo.svg')}}" alt="logo"/>--}}
        </a>
    </div>
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="nav-item nav-item-has-children">
                <a
                    href="#"
                    class="{{ request()->is('bidSetting/*') ? '' : 'collapsed' }}"
                    data-bs-toggle="collapse"
                    data-bs-target="#bidSetting"
                    aria-controls="bidSetting"
                    aria-expanded="{{ request()->is('bidSetting/*') }}"
                    aria-label="Toggle navigation"
                >
        <span class="icon">
            <i class="mdi mdi-home"></i>
        </span>
                    <span class="text">बोलपत्र</span>
                </a>
                <ul id="bidSetting"
                    class="collapse dropdown-nav {{ request()->is('bidSetting/*') ? 'show' : '' }}">
                    <li>
                        <a class="{{ request()->is('bidSetting') ? 'active' : '' }}"
                           href="{{ route('admin.bid-setting.index') }}">
                            बोलपत्र सेटिंग
                        </a>
                    </li>
                    <li>
                        <a class="{{ request()->is('bidSetting') ? 'active' : '' }}"
                           href="{{ route('admin.fiscal-year.index') }}">
                            आर्थिक वर्ष
                        </a>
                    </li>
                    <li>
                        <a class="{{ request()->is('bidSetting') ? 'active' : '' }}"
                           href="{{ route('admin.bid-office.index') }}">
                           निकायको नाम
                        </a>
                    </li>
                    <li>
