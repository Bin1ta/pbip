...
$data=$obj->regNotice($niti,$cid,$today);
}
 ...
 <div class="panel-body">
  ...
  <div class="col-lg-5">
<input type="text" name="niti" placeholder="सुचना शिर्षक" required="required" class="form-control">
</div>
...
if($data['action']=='1'){
                                                      ?>
                                                      <a class="btn btn-danger" href="del.php?noid=<?php echo $data['id']; ?>" onclick="return confirm(&quot;के तपाई यस विवरण खारेज गर्न चाहनुहुन्छ ? याद गर्नुहोस् एक पटक हटाइएको विवरण पुनः ल्याउन सकिने छैन ।&quot;)"><i class="fa fa-trash-o"></i> Delete</a>
                                                  <?php } ?>
                                               </td>
