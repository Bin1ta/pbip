...
$data=$obj->regNiti($niti,$cid,$today,$pg,$fy);
 ...
 <div class="panel-body">
  ...
  <div class="col-lg-5">
<input type="text" name="niti" placeholder="नमुना फारम" required="required" class="form-control">
</div>
  <div class="col-lg-4">
...
if($data['action']=='1'){
                                                      ?>
                                                      <a class="btn btn-danger" href="del.php?nid=<?php echo $data['id']; ?>&pg=<?php $_REQUEST['pg']; ?>&fn=<?php echo $data['file_name']; ?>" onclick="return confirm(&quot;के तपाई यस विवरण खारेज गर्न चाहनुहुन्छ ? याद गर्नुहोस् एक पटक हटाइएको विवरण पुनः ल्याउन सकिने छैन ।&quot;)"><i class="fa fa-trash-o"></i> Delete</a>
                                                  <?php } ?>
                                               </td>
