...
use App\Http\Controllers\Admin\{BillController,
    ...
    Setting\BidController,
    Setting\BidOfficeController,
    Setting\BidSettingController,
    Setting\FiscalYearController,
    SliderController,
    SmugglingController,
...
Route::resource('smuggling', SmugglingController::class);
    ...
    Route::resource('bid-office', BidOfficeController::class);
